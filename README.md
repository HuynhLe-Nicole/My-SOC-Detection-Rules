...
## Threat Detection Rules Mapping to MITRE ATT&CK

| Rule File                              | Threat Detected                         | MITRE ATT&CK Technique       |
|----------------------------------------|-----------------------------------------|------------------------------|
| `powershell_encoded_command.yml`       | Malicious encoded PowerShell            | T1059.001                    |
